...
const logger = require("../catalogs/shaonc.js");
...
console.log(`${crayon(``)}${sky(`• SHAON PROJECT DATA •`)} - bot name : ${chalk.blueBright((!global.config.BOTNAME) ? "Shaon" : global.config.BOTNAME)} \n${sky(`• SHAON PROJECT DATA •`)} - bot id : ${chalk.blueBright(api.getCurrentUserID())} \n${sky(`• SHAON PROJECT DATA •`)} - bot prefix : ${chalk.blueBright(global.config.PREFIX)}\n${sky(`• SHAON PROJECT DATA •`)} - deployed ${chalk.blueBright(operator)} bot operators and ${chalk.blueBright(admin)} admins`);
if (global.config.approval) {
  console.log(`${sky(`• SHAON PROJECT DATA •`)} - deployed ${chalk.blueBright(approved)} approved groups`)
} 
if (global.config.premium) {
  console.log(`${sky(`• SHAON PROJECT DATA •`)} - deployed ${chalk.blueBright(premium)} premium users`)
}
